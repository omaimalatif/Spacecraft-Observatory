...
export default function EoSkyPlot({ satellites, mask, onMaskChange, catalogSize, location, onSelect }) {
  ...
  useEffect(() => {
    ...
    api.earthObservationSkyTracks({ lat: location.lat, lon: location.lon, minElevation: mask, windowMin: 25 })
