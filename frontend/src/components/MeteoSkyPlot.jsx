...
import { CATEGORY_COLOR, CATEGORY_ORDER } from './MeteoGlobe.jsx'
...
export default function MeteoSkyPlot({ satellites, mask, onMaskChange, catalogSize, location, onSelect }) {
  ...
  useEffect(() => {
    ...
    api.meteorologicalSkyTracks({ lat: location.lat, lon: location.lon, minElevation: mask, windowMin: 25 })
