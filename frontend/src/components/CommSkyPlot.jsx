...
import { CATEGORY_COLOR, CATEGORY_ORDER } from './CommGlobe.jsx'
...
export default function CommSkyPlot({ satellites, mask, onMaskChange, catalogSize, location, onSelect }) {
  ...
  useEffect(() => {
    ...
    api.communicationSkyTracks({ lat: location.lat, lon: location.lon, minElevation: mask, windowMin: 25 })
