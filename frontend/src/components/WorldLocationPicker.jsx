...
export default function WorldLocationPicker({ lat, lon, onPick, satellites = [] }) {
  ...
  return (
    <div className={`world-picker-map ${fullscreen ? 'world-picker-map-fullscreen' : ''}`}>
      ...
      <div className="map-constellation-legend" aria-label="Satellite constellation legend">
        <strong>Satellite constellations</strong>
        {CONSTELLATION_ORDER.map((constellation) => (
          <span key={constellation}>
            <i style={{ background: CONSTELLATION_COLOR[constellation] }} />{constellation}
          </span>
        ))}
      ...
      >
        ...
        {satellites.map((satellite) => (
          <CircleMarker
            ...
            radius={5}
            pathOptions={{
              color: CONSTELLATION_COLOR[satellite.constellation] || CONSTELLATION_COLOR.Other,
              fillColor: CONSTELLATION_COLOR[satellite.constellation] || CONSTELLATION_COLOR.Other,
              fillOpacity: 0.85,
              weight: 1,
            }}
          >
            <Tooltip direction="top" offset={[0, -5]}>
              ...
              <br />{satellite.constellation || 'Unknown constellation'}
            </Tooltip>
